...
export const products: Product[] = [
	...
	{ id: "frozen-figs", name: "Figs", slug: toSlug("Figs"), category: "frozen", description: "Whole or halved; sweet and delicate flavor.", images: [ { url: orangesAlt2, alt: "Figs placeholder" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-blueberries", name: "Blueberries", slug: toSlug("Blueberries"), category: "frozen", description: "IQF blueberries, perfect for smoothies and baking.", images: [ { url: orangesAlt2, alt: "Blueberries placeholder" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-carrots", name: "Carrots", slug: toSlug("Carrots"), category: "frozen", description: "Diced or sliced; sweet and nutritious.", images: [ { url: freshCarrots, alt: "Frozen carrots" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-onions", name: "Onions", slug: toSlug("Onions"), category: "frozen", description: "Diced or sliced; essential for cooking.", images: [ { url: freshOnions, alt: "Frozen onions" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-pepper", name: "Pepper", slug: toSlug("Pepper"), category: "frozen", description: "Bell peppers, diced or strips; colorful and versatile.", images: [ { url: orangesAlt2, alt: "Pepper placeholder" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-molokhia", name: "Molokhia", slug: toSlug("Molokhia"), category: "frozen", description: "Traditional Egyptian leafy green, perfect for soups.", images: [ { url: orangesAlt2, alt: "Molokhia placeholder" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-sweet-potatoes", name: "Sweet Potatoes", slug: toSlug("Sweet Potatoes"), category: "frozen", description: "Diced or sliced; naturally sweet and nutritious.", images: [ { url: freshSweetPotatoes, alt: "Frozen sweet potatoes" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{ id: "frozen-artichoke", name: "Artichoke", slug: toSlug("Artichoke"), category: "frozen", description: "Hearts or whole; tender and flavorful, perfect for Mediterranean dishes.", images: [ { url: artichokeMain, alt: "Frozen artichoke" } ], specs: { Packaging: "400g retail packs, 1kg, 2.5kg, and bulk 10kg cartons", Shelf_Life: "18–24 months at -18°C" } },
	{
		id: "cauliflower",
		name: "Cauliflower",
