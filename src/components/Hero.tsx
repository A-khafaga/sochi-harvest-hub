...
const Hero = () => {
  ...
  return (
    <section id="home" className="bg-gray-200">
      ...
      <div className="w-full relative h-[60vh] min-h-[440px] md:min-h-[560px] lg:min-h-[620px] max-h-[760px] overflow-hidden">
        ...
        {/* Fixed-width content container inside full-width background */}
        <div className="absolute inset-0 z-10">
          <div className="max-w-7xl mx-auto h-full relative">
            {/* Overlay hero graphic and buttons */}
            <div className="md:ml-10 absolute inset-0 flex items-center justify-start pl-4 sm:pl-6 md:pl-12">
              <div className="relative pointer-events-none">
                <img src={heroOverlay} alt="" aria-hidden="true" className="w-[180px] sm:w-[240px] md:w-[360px] lg:w-[440px] xl:w-[520px] h-auto object-contain" />
